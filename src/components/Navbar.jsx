    ...
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-4xl mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="text-2xl font-bold text-amber-600 flex items-center gap-2">
          ...
          <span className="tracking-tight">Eastlify</span>
        </Link>
        
        <div className="flex items-center gap-4">
          <Link to="/browse" className="text-gray-600 hover:text-amber-600 font-medium hidden sm:flex items-center gap-1">
          ...
          {currentUser ? (
            <div className="flex items-center gap-3">
              <Link to="/dashboard" className="flex items-center gap-1 text-sm font-medium text-gray-700 hover:text-amber-600 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-200">
                ...
                <span className="hidden xs:block line-clamp-1 max-w-[100px]">{currentUser.name}</span>
              </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/register" className="bg-amber-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-700 transition shadow-sm">
                Register Shop
              </Link>
            </div>
          )}
